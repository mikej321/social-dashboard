            ...
            <div className="social_card_container">
                <div className="social_card card_facebook">
                    ...
                    <div className="trending_container">
                        ...
                        <p className="percentage_up">12 Today</p>
                    </div>
                </div>
                <div className="social_card card_twitter">
                    <div className="user_name_container">
                    ...
                    <div className="trending_container">
                        <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg>
                        <p className="percentage_up">99 Today</p>
                    </div>
                </div>
                <div className="social_card card_instagram">
                    <div className="user_name_container">
                    ...
                    <div className="trending_container">
                        <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg>
                        <p className="percentage_up">1099 Today</p>
                    </div>
                </div>
                <div className="social_card card_youtube">
                    <div className="user_name_container">
                    ...
                    <div className="trending_container">
                        ...
                        <p className="percentage_down">144 Today</p>
                    </div>
                </div>
            </div>
        </>
            ...
            <div className="overview_card_container">
                ...
                <div className="overview_card">
                    ...
                    <div className="stats_container">
                        ...
                        <div className="percentage_container">
                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#DC414C" fill-rule="evenodd" d="M0 0l4 4 4-4z"/></svg>
                            <p className="percentage_down">2%</p>
                        </div>
                    </div>
                </div>
                <div className="overview_card">
                    ...
                    <div className="stats_container">
                        ...
                        <div className="percentage_container">
                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg>
                            <p className="percentage_up">2257%</p>
                        </div>
                    </div>
                </div>
                <div className="overview_card">
                    ...
                    <div className="stats_container">
                        ...
                        <div className="percentage_container">
                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg>
                            <p className="percentage_up">1375%</p>
                        </div>
                    </div>
                </div>  
                <div className="overview_card">
                    ...
                    <div className="stats_container">
                        ...
                        <div className="percentage_container">
                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg>
                            <p className="percentage_up">303%</p>
                        </div>
                    </div>
                </div>
                <div className="overview_card">
                    ...
                    <div className="stats_container">
                        ...
                        <div className="percentage_container">
                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg>
                            <p className="percentage_up">553%</p>
                        </div>
                    </div>
                </div>
                <div className="overview_card">
                    ...
                    <div className="stats_container">
                        ...
                        <div className="percentage_container">
                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#DC414C" fill-rule="evenodd" d="M0 0l4 4 4-4z"/></svg>
                            <p className="percentage_down">19%</p>
                        </div>
                    </div>
                </div>
                <div className="overview_card">
                    ...
                    <div className="stats_container">
                        ...
                        <div className="percentage_container">
                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#DC414C" fill-rule="evenodd" d="M0 0l4 4 4-4z"/></svg>
                            <p className="percentage_down">12%</p>
                        </div>
                    </div>
                </div>
            </div>
